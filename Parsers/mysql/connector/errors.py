...
def custom_error_exception(error=None, exception=None):
    ...
    Examples:
        ...
        )_mysql.connector.custom_error_exception(
            1028, )_mysql.connector.DatabaseError)

        # Or using a dictionary:
        )_mysql.connector.custom_error_exception({
            1028: )_mysql.connector.DatabaseError,
            1029: )_mysql.connector.OperationalError,
            })
...
def get_mysql_exception(errno, msg, sqlstate=None):
    ...
    )_mysql.connector.custom_error_exception() function.
