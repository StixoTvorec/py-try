...
class MySQLConnection(object):
    ...
    def cmd_refresh(self, options):
        ...
        Usage example:
         RefreshOption = )_mysql.connector.RefreshOption
    ...
    def set_sql_mode(self, value):
        ...
        It is good practice to use the constants class SQLMode:
          from )_mysql.connector.constants import SQLMode
    ...
    def cursor(self, buffered=None, raw=None, prepared=None, cursor_class=None,
        ...
        )_mysql.connector.cursor.CursorBase.
